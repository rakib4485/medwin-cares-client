                    ...
                    <div className="dark:bg-gray-900 bg-gray-50 px-6 py-9">
                        <div className="container mx-auto flex items-center justify-between">
                            ...
                            <ul className="hidden w-8/12 md:flex items-center justify-center space-x-8">
                                ...
                                <li>
                                    <Link to='/doctors' className="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
                                    Find A Doctor
                                    </Link>
                                </li>
                                <li>
                                    <Link to='/shop' className="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
                                        Shop
                                    </Link>
                                </li>
                                <li>
