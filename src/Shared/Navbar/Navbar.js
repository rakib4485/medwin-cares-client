                ...
                <div className="relative">
                    ...
                    <div className=" px-6 py-9">
                        <div className="container mx-auto flex items-center justify-between">
                            <Link to='/' className="md:w-2/12 cursor-pointer uppercase font-semibold text-2xl" aria-label="">
                                <span className='text-gray-400'>medwin</span> <span>cares</span>
                            </Link>
                            <ul className="hidden w-8/12 md:flex items-center justify-center space-x-8">
                                <li>
                                    <Link href="javascript:void(0)" className="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
                                        Home
                                    </Link>
                                </li>
                                <li>
                            ...
                            <div className="md:w-2/12 justify-end flex items-center space-x-4 xl:space-x-8">
                                ...
                                <div className="hidden lg:flex items-center space-x-4 xl:space-x-8">
                                    <Link label="go to cart" className="text-2xl">
                                        <HiOutlineUser/>
                                    </Link>
                                </div>
                    ...
                    <div id="mobile-menu" className={`${showMenu ? "flex" : "hidden"} absolute dark:bg-gray-900 z-10 inset-0 md:hidden bg-white flex-col h-screen w-full`}>
                        <div className="mt-6 p-4">
                            <ul className="flex flex-col space-y-6">
                                <li>
                                    <Link href="javascript:void(0)" className="dark:text-white flex items-center justify-between hover:underline text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800">
                                        Home
                                        <div>
                        ...
                        <div className="h-full flex items-end">
                            <ul className="flex flex-col space-y-8 bg-gray-50 w-full py-10 p-4 dark:bg-gray-800">
                                ...
                                <li>
                                    <Link href="javascript:void(0)" className="dark:text-white text-gray-800 flex items-center space-x-2 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
                                        <div>
